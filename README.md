ArtCollab is an interactive web application designed to allow users to share, explore, and engage with artwork in a dynamic and visually engaging environment. The goal of the project is to create a collaborative space where users can interact with content rather than passively view it.
